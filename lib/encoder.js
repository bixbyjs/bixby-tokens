exports = module.exports = function(container, logger) {
  ...
  for (i = 0, len = specs.length; i < len; ++i) {
    spec = specs[i];
    if ((spec.implements || []).indexOf('http://schemas.modulate.io/js/security/tokens/encodeFunc') !== -1) {
...
exports['@implements'] = 'http://schemas.modulate.io/js/security/tokens/Encoder';
